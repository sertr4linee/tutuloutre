      ...
      <div className="relative z-30 flex items-center justify-center min-h-screen py-4 sm:py-6 md:py-8 lg:py-12 px-3 sm:px-4">
        <div className="relative w-[98%] sm:w-[95%] md:w-[92%] lg:w-[90%] max-w-6xl bg-[#FFFBF5] border-[4px] sm:border-[6px] md:border-[8px] lg:border-[10px] border-black mx-auto">
              ...
              <div className="relative">
                ...
                {activeTab === "socials" && (
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    {[
                      { name: "Instagram", icon: "instagram", color: "#E1306C", username: "@une_mome" },
                      { name: "Twitter", icon: "twitter", color: "#1DA1F2", username: "@une_mome" },
                      { name: "Dribbble", icon: "dribbble", color: "#EA4C89", username: "maelle" },
                      { name: "LinkedIn", icon: "linkedin", color: "#0077B5", username: "maelle-crescence" },
                      { name: "Behance", icon: "behance", color: "#1769FF", username: "maellecrescence" },
                      { name: "Pinterest", icon: "pinterest", color: "#E60023", username: "une_mome" },
                    ].map((social, index) => (
                      <div
                        key={index}
                      ...
                      >
                        ...
                        <div className="relative border-3 border-black rounded-xl p-4 flex flex-col items-center text-center transition-all bg-white overflow-hidden group-hover:-translate-y-1">
                          {/* Hover effect */}
                          <div
                            className={`absolute inset-0 bg-[${social.color}] opacity-0 transition-opacity group-hover:opacity-10 rounded-xl`}
                            style={{
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      ...
                      <div className="bg-[#FFE8DD] border-2 border-black p-4 rounded-lg relative">
                        ...
                        <p className="text-[#3C3C3C]">Paris, France</p>
                      </div>
                      ...
                      <div className="bg-[#FFE8DD] border-2 border-black p-4 rounded-lg relative">
                        ...
                        <p className="text-[#3C3C3C]">Monday - Friday: 9am - 6pm</p>
                      </div>
                    </div>
                      ...
                      <div className="relative border-4 border-black rounded-xl overflow-hidden h-[300px] md:h-full">
                        ...
                        <div className="w-full h-full bg-[#FFE8DD] flex items-center justify-center relative">
                          ...
                          <div className="relative">
                            ...
                            <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-white px-3 py-1 rounded-full border-2 border-black font-bold text-sm">
                              Paris, FR
                            </div>
                          </div>
                        </div>
          ...
          >
            ...
            >
              <img src="/mouse.svg" alt="Mouse cursor" className="w-full h-full" />
            </div>
          </div>
        </div>
      </div>
