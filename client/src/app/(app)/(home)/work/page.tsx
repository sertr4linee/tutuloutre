...
export default function WorkPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden">
      ...
      {/* Portfolio content with neobrutalism design - MOVED TO TOP */}
        ...
        <div className="relative">
          ...
          <div className="relative border-4 sm:border-6 border-black bg-white p-4 sm:p-6 md:p-8 rounded-xl">
            ...
            <div className="mt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
                  ...
                  {data.blogs[0] && (
                    <div className="md:col-span-8">
                      <BlogCard blog={data.blogs[0]} featured={true} />
                    </div>
                  )}
              ...
              {data?.blogs && data.blogs.length > 3 && (
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {data.blogs.slice(3).map((blog) => (
                    <BlogCard key={blog.id} blog={blog} />
                  ))}
                </div>
              )}
              ...
              {data?.blogs && data.blogs.length > 6 && (
